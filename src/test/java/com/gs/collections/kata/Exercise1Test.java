...
//        Function<Customer, String> nameFunction = object -> object.getName();
        ...
        MutableList<String> customerNames = Lists.mutable.of();
    ...
    {
//        Predicate<Customer> fromLondon = new Predicate<Customer>() {
//            @Override
...
//        };
        ...
        Predicate<Customer> fromLondon = customer -> "London".equals(customer.getCity());

        /**
         * Which customers come from London? Get a collection of those which do.
         */
        MutableList<Customer> customers = this.company.getCustomers();
        MutableList<Customer> customersFromLondon = customers.select(fromLondon);
