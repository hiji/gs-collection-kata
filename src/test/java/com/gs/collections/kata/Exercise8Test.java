...
//        MutableMap<String, Double> map = null;
        MapIterable<String, Double> map = this.company.getCustomers().aggregateBy(Customer::getCity, zeroValueFactory, aggregator);
    ...
    public void sortedOrders() {
        MutableSortedBag<Double> orderedPrices
                ...
                .toSortedBag((o1, o2) -> o2.compareTo(o1));
    ...
    public void whoOrderedSaucers()
    {
        MutableList<Customer> customersWithSaucers
                ...
                .select(customer -> customer.getOrders().flatCollect(Order::getLineItems)
    ...
    public void mostExpensiveItem()
    {
        MutableListMultimap<Double, Customer> multimap
                = this.company.getCustomers().groupBy(customer ->
                        customer.getOrders().flatCollect(Order::getLineItems).collect(LineItem::getValue).max());
