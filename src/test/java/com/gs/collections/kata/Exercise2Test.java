...
//    private static final Predicate<Customer> CUSTOMER_FROM_LONDON = Predicates.attributeEqual(Customer::getCity, "London");
    ...
    public void doAnyCustomersLiveInLondon()
    {
        ...
        boolean anyCustomersFromLondon = customers.anySatisfy(CUSTOMER_FROM_LONDON);
...
//        Customer mary = this.company.getCustomers().detect(customer -> "Mary".equals(customer.getName()));
