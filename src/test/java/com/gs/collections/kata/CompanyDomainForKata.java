...
//        fredOrder.addLineItem(new LineItem("cup", 1.5));
//        fredOrder.addLineItem(new LineItem("cup", 1.5));
        fredOrder.addOccurrences(new LineItem("cup", 1.5), 3);

        // TODO 7: Add 3 saucers at 1.0 each to the order
//        fredOrder.addLineItem(new LineItem("saucer", 1.0));
//        fredOrder.addLineItem(new LineItem("saucer", 1.0));
//        fredOrder.addLineItem(new LineItem("saucer", 1.0));
        fredOrder.addOccurrences(new LineItem("saucer", 1.0), 3);
...
//        maryOrder.addLineItem(new LineItem("cup", 1.5));
//        maryOrder.addLineItem(new LineItem("cup", 1.5));
        maryOrder.addOccurrences(new LineItem("cup", 1.5), 4);
...
//        maryOrder.addLineItem(new LineItem("saucer", 1.5));
//        maryOrder.addLineItem(new LineItem("saucer", 1.5));
        maryOrder.addOccurrences(new LineItem("saucer", 1.5), 4);
...
//        }
        billOrder1.addOccurrences(new LineItem("gnome", 7.50), 43);
